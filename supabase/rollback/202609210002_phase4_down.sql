...
drop function if exists public.api_create_order(uuid, uuid, text, text, public.payment_method, text, text, text, jsonb);
...
-- Requiere que no existan pedidos de entrega con pickup_location_id nulo.
