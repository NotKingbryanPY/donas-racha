...
El ranking público de la API nueva omite los IDs y la web ya no consulta el ranking antiguo como respaldo. El despliegue antiguo de Apps Script aún puede entregar IDs directamente a quien conozca su URL; eliminar esa exposición requiere actualizar o retirar ese despliegue. El ranking del panel de vendedor conserva sus enlaces a clientes mediante la ruta administrativa.
