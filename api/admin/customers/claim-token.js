...
module.exports = withApi(['POST'], async (req, context) => {
  ...
  const token = await userRpc('issue_customer_claim_token', {
    p_customer_id:customerId,p_ttl:'00:30:00'
  }, req.headers.authorization);
  if (typeof token !== 'string') throw new ApiError(502, 'CLAIM_INVALID_RESPONSE', 'No se generó el código de vinculación.');
